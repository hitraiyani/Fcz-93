...
export function TopSaleHomeProduct({
  ...
  return (
    <Section {...props} className={`${className} TopSaleHomeProduct primary-bg-color py-10`}>
      <div className="container mx-auto">
        ...
        <div className="flex justify-center flex-wrap pro-items -mx-2 gap-y-8">
            ...
            if (product) {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div className="card-image aspect-[2/2] bg-white">
                      {inDisc && (
                        <Text
                          as="label"
                          size="fine"
          ...
          <div className="pro-item-last w-2/4 xl:w-1/4 px-2">
            <Link
              className="flex pb-3 relative border-4 border-white p-3 items-end aspect-square"
              to={`/collections/${title_handle}`}
            >
              <div className="font-black text-lg md:text-4xl text-black italic leading-none">
                EXPORE <br/>EVERYTHING <span className='text-white block font-medium text-2xl sm:text-4xl md:text-5xl'>>>>>>>>>>>>>></span>
              </div>
            </Link>
          </div>
        </div>
