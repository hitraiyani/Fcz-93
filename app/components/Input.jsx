...
export function Input({className = '', type, variant, ...props}) {
  const variants = {
    ...
    minisearch:
      'bg-transparent hidden md:inline-block text-left transition border-transparent appearance-none px-0 py-1 focus:outline-0 placeholder:text-white text-white',
  };
